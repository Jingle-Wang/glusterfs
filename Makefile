...
DIST_COMMON = $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/contrib/uuid/uuid_types.h.in \
...
ACLOCAL = ${SHELL} /root/glusterfs/missing --run aclocal-1.11
ACL_LIBS = -lacl
AMTAR = ${SHELL} /root/glusterfs/missing --run tar
...
AUTOCONF = ${SHELL} /root/glusterfs/missing --run autoconf
AUTOHEADER = ${SHELL} /root/glusterfs/missing --run autoheader
AUTOMAKE = ${SHELL} /root/glusterfs/missing --run automake-1.11
AWK = gawk
BUILD_PYTHON_INC = /usr/include/python2.6
BUILD_PYTHON_LIB = python2.6
BUILD_PYTHON_SITE_PACKAGES = /usr/lib/python2.6/site-packages
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -g -O2 -Wformat -Werror=format-security -Werror=implicit-function-declaration
...
GFAPI_VERSION = 7.3.7.6
GF_CFLAGS =  -g -O2 -g -O2 -Wformat -Werror=format-security -g -O2 -g -O2 -Wformat -Werror=format-security -Werror=implicit-function-declaration
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/glusterfs/missing --run makeinfo
MATH_LIB = -lm
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_RELEASE = 0
PACKAGE_STRING = glusterfs 3.7.6
...
PYTHONDEV_LDFLAGS =  -L/usr/lib -L/usr/${exec_prefix}/lib -lpthread -ldl -lutil -lm -lpython2.6
PYTHON_CFLAGS = 
...
UNITTEST_LDFLAGS =  
UNITTEST_LIBS = 
URCU_CDS_CFLAGS = -I/usr/local/include  
URCU_CDS_LIBS = -L/usr/local/lib -lurcu-cds  
URCU_CFLAGS = -I/usr/local/include  
URCU_LIBS = -L/usr/local/lib -lurcu-bp  
USE_POSIX_ACLS = 1
...
ZLIB_CFLAGS =  
ZLIB_LIBS = -lz
abs_builddir = /root/glusterfs
abs_srcdir = /root/glusterfs
abs_top_builddir = /root/glusterfs
abs_top_srcdir = /root/glusterfs
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
initdir = /etc/init.d
install_sh = ${SHELL} /root/glusterfs/install-sh
